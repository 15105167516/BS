...
!function (e) {
    ...
    t = {
        ...
        starCaptionClasses: {
            ...
            1.1: "label label-info",
            1.2: "label label-primary",
            1.3: "label label-primary",
            1.4: "label label-success",
            1.5: "label label-danger",
            1.6: "label label-info",
            1.7: "label label-info",
            1.8: "label label-primary",
            1.9: "label label-primary",
            2: "label label-danger",
            2.1: "label label-info",
            2.2: "label label-primary",
            2.3: "label label-primary",
            2.4: "label label-success",
            2.5: "label label-danger",
            2.6: "label label-info",
            2.7: "label label-info",
            2.8: "label label-primary",
            2.9: "label label-primary",
            3: "label label-danger",
            3.1: "label label-info",
            3.2: "label label-primary",
            3.3: "label label-primary",
            3.4: "label label-success",
            3.5: "label label-danger",
            3.6: "label label-info",
            3.7: "label label-info",
            3.8: "label label-primary",
            3.9: "label label-primary",
            4: "label label-danger",
            4.1: "label label-info",
            4.2: "label label-primary",
            4.3: "label label-primary",
            4.4: "label label-success",
            4.5: "label label-danger",
            4.6: "label label-info",
            4.7: "label label-info",
            4.8: "label label-primary",
            4.9: "label label-primary",
            5: "label label-danger"
